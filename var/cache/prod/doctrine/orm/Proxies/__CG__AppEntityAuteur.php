...
class Auteur extends \App\Entity\Auteur implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Auteur' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Auteur' . "\0" . 'nom', '' . "\0" . 'App\\Entity\\Auteur' . "\0" . 'prenom', '' . "\0" . 'App\\Entity\\Auteur' . "\0" . 'dateDeNaissance', '' . "\0" . 'App\\Entity\\Auteur' . "\0" . 'biographie', '' . "\0" . 'App\\Entity\\Auteur' . "\0" . 'articles'];
        }
     ...
     * {@inheritDoc}
     */
    public function setDateDeNaissance(\DateTimeInterface $dateDeNaissance): \App\Entity\Auteur
    {
     ...
     * {@inheritDoc}
     */
    public function setBiographie(string $biographie): \App\Entity\Auteur
    {
