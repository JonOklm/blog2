...
class getDoctrine_Orm_DefaultEntityManagerService extends App_KernelProdContainer
{
    ...
    {
        if (true === $lazyLoad) {
            return $container->services['doctrine.orm.default_entity_manager'] = $container->createProxy('EntityManager_c7f04bd', fn () => \EntityManager_c7f04bd::createLazyGhost(fn ($proxy) => self::do($container, $proxy)));
        }
