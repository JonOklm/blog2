...
class __TwigTemplate_24eb5907628eb4990d209f476d3c41cf extends Template
{
    private $source;
    private $macros = [];
        ...
        ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["article"]) {
                ...
                echo "
                        <p class=\"card-text\">";
                // line 50
                echo twig_escape_filter($this->env, twig_slice($this->env, twig_get_attribute($this->env, $this->source, $context["article"], "contenu", [], "any", false, false, false, 50), 0, 100), "html", null, true);
                echo "...</p>
                        <a href=\"";
                // line 51
