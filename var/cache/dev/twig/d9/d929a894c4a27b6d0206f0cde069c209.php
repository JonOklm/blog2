...
class __TwigTemplate_71d009ccfda8294d8df20ef3ff46966d extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "categorie/categorieForm.html.twig"));
...
";
    ...
    ";
        // line 10
        echo         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["formCategorie"]) || array_key_exists("formCategorie", $context) ? $context["formCategorie"] : (function () { throw new RuntimeError('Variable "formCategorie" does not exist.', 10, $this->source); })()), 'form');
        echo "
...
";
    ...
    {
        return array (  117 => 31,  105 => 25,  100 => 23,  97 => 22,  93 => 21,  79 => 10,  75 => 8,  68 => 7,  60 => 4,  53 => 3,  36 => 1,);
    }
...
<h1>Ajout d'une catégories</h1>
    ...
    <tbody>
        ...
        <tr>
            <td>{{ categorie.nom }}</td>
            <td>
                <a href=\"{{ path('app_categorie_update', {slug: categorie.slug}) }}\"> <i class=\"fas fa-edit mx-1 text-center text-success\" title=\"editer\"></i></a>
                <a href=\"\" onClick=\"return confirm('êtes vous sûr de vouloir supprimer la categorie ?')\"><i class=\"fas fa-trash mx-1 text-center text-danger\" title=\"supprimer\"></i></a>
                <a href=\"\"> <i class=\"fas fa-eye mx-1 text-center\" title=\"voir\"></i></a>
            </td>
        </tr>
...
{% endblock %}
", "categorie/categorieForm.html.twig", "C:\\Users\\madou\\OneDrive\\Bureau\\SYMFONY\\blog2\\templates\\categorie\\categorieForm.html.twig");
    }
}
