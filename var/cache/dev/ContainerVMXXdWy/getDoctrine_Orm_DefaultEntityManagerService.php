...
class getDoctrine_Orm_DefaultEntityManagerService extends App_KernelDevDebugContainer
{
    ...
    {
        if (true === $lazyLoad) {
            return $container->services['doctrine.orm.default_entity_manager'] = $container->createProxy('EntityManager_51e8656', fn () => \EntityManager_51e8656::createLazyGhost(fn ($proxy) => self::do($container, $proxy)));
        }
